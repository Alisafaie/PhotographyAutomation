...
(
	...
	CONSTRAINT [PK_TblAlbums] PRIMARY KEY CLUSTERED([Id] ASC)WITH (
	    PAD_INDEX = OFF,
...
(
	...
	[PrintSizeId]     [int] NOT NULL,
	[Price]           [int] NOT NULL,
	CONSTRAINT [PK_TblCustomerFilePrint] PRIMARY KEY CLUSTERED([Id] ASC)WITH (
	    PAD_INDEX = OFF,
	    STATISTICS_NORECOMPUTE = OFF,
	    IGNORE_DUP_KEY = OFF,
	    ALLOW_ROW_LOCKS = ON,
...
(
	...
	CONSTRAINT [PK_TblItalianAlbum] PRIMARY KEY CLUSTERED([Id] ASC)WITH (
	    PAD_INDEX = OFF,
	    STATISTICS_NORECOMPUTE = OFF,
	    IGNORE_DUP_KEY = OFF,
	    ALLOW_ROW_LOCKS = ON,
...
(
	...
	[Price]              [int] NOT NULL,
	CONSTRAINT [PK_TblPrintServicePrices] PRIMARY KEY CLUSTERED([Id] ASC)WITH (
	    PAD_INDEX = OFF,
	    STATISTICS_NORECOMPUTE = OFF,
	    IGNORE_DUP_KEY = OFF,
	    ALLOW_ROW_LOCKS = ON,
...
(
	...
	CONSTRAINT [PK_TblPrintSizePrices] PRIMARY KEY CLUSTERED([Id] ASC)WITH (
	    PAD_INDEX = OFF,
	    STATISTICS_NORECOMPUTE = OFF,
	    IGNORE_DUP_KEY = OFF,
	    ALLOW_ROW_LOCKS = ON,
...
(
	...
	CONSTRAINT [PK_TblPrintSizes] PRIMARY KEY CLUSTERED([Id] ASC)WITH (
	    PAD_INDEX = OFF,
	    STATISTICS_NORECOMPUTE = OFF,
	    IGNORE_DUP_KEY = OFF,
	    ALLOW_ROW_LOCKS = ON,
...
(
	...
	[Price]           [int] NOT NULL,
	[Description]     [nvarchar](500) NULL,
	CONSTRAINT [PK_TblSpecialServices] PRIMARY KEY CLUSTERED([Id] ASC)WITH (
	    PAD_INDEX = OFF,
	    STATISTICS_NORECOMPUTE = OFF,
	    IGNORE_DUP_KEY = OFF,
	    ALLOW_ROW_LOCKS = ON,
...
GO
/****** Object:  View [dbo].[View_]    Script Date: 8/18/2019 1:25:09 PM ******/
--SET ANSI_NULLS ON
--GO
--SET QUOTED_IDENTIFIER ON
--GO
...
GO
ALTER TABLE [dbo].[TblPrintSizes] ADD  CONSTRAINT [DF_TblPrintSizes_HasScanAndProcessing]  DEFAULT((1)) FOR 
...
WITH CHECK ADD CONSTRAINT [FK_TblAlbums_TblPrintSizes] FOREIGN KEY([PrintSizeId])
...
WITH CHECK ADD CONSTRAINT [FK_TblCustomerFilePrint_TblPrintSizes] FOREIGN KEY([PrintSizeId])
     REFERENCES [dbo].[TblPrintSizes] ([Id])
GO
ALTER TABLE [dbo].[TblPrintCustomerFiles] CHECK CONSTRAINT [FK_TblCustomerFilePrint_TblPrintSizes]
GO
ALTER TABLE [dbo].[TblPrintItalianAlbums]  
WITH CHECK ADD CONSTRAINT [FK_TblItalianAlbum_TblPrintSizes] FOREIGN KEY([PrintSizeId])
     REFERENCES [dbo].[TblPrintSizes] ([Id])
GO
...
WITH CHECK ADD CONSTRAINT [FK_TblPrintServicePrice_TblPrintServices1] FOREIGN KEY([PrintServiceId])
     REFERENCES [dbo].[TblPrintServices] ([Id])
GO
ALTER TABLE [dbo].[TblPrintServicePrices] CHECK CONSTRAINT [FK_TblPrintServicePrice_TblPrintServices1]
GO
ALTER TABLE [dbo].[TblPrintServicePrices]  
WITH CHECK ADD CONSTRAINT [FK_TblPrintServicePrice_TblPrintSizes] FOREIGN KEY([PrintSizeId])
     REFERENCES [dbo].[TblPrintSizes] ([Id])
GO
...
WITH CHECK ADD CONSTRAINT [FK_TblSizePrice_TblPrintSizes1] FOREIGN KEY([PrintSizeId])
     REFERENCES [dbo].[TblPrintSizes] ([Id])
GO
