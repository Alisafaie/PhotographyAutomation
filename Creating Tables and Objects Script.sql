 ...
 * Time:   8/21/2019 9:31:33 PM
 * Source: fn_diagramobjects, Photos, sp_alterdiagram, sp_creatediagram, sp_dropdiagram, 
 *         sp_helpdiagramdefinition, sp_helpdiagrams, sp_renamediagram, sp_upgraddiagrams, 
 *         TblAlbums, TblAllOrderStatus, TblAtelierType, TblBooking, TblBookingStatus, 
 ...
 *         TblPrintCustomerFiles, TblPrintItalianAlbums, TblPrintServicePrices, TblPrintServices, 
 *         TblPrintSizePrices, TblPrintSizes, TblPrintSpecialServices, usp_CreateCustomerFinancialDirectory, 
 *         usp_CreateFileTableFile, usp_CreateMonthFolder, usp_CreateYearFolder, 
 *         usp_DeleteOrderFolderFiles, usp_GetImageInfo, usp_GetListOfFilesInFolder, 
...
/* [PhotographyAutomationDB].[dbo].[sp_alterdiagram] */
...
/* [PhotographyAutomationDB].[dbo].[sp_creatediagram] */
...
/* [PhotographyAutomationDB].[dbo].[sp_dropdiagram] */
...
/* [PhotographyAutomationDB].[dbo].[sp_helpdiagramdefinition] */
...
/* [PhotographyAutomationDB].[dbo].[sp_helpdiagrams] */
...
/* [PhotographyAutomationDB].[dbo].[sp_renamediagram] */
...
/* [PhotographyAutomationDB].[dbo].[sp_upgraddiagrams] */
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'stream_id ????? ?? ????? ????? ?? ???' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TblOrder', @level2type=N'COLUMN',@level2name=N'OrderFolderStreamId'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'??????? ????? ?? ????? ????? ?? ???.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TblOrder', @level2type=N'COLUMN',@level2name=N'OrderFolderPathLocator'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'??????? ????? ?? ????? ????? ?? ???.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TblOrder', @level2type=N'COLUMN',@level2name=N'OrderFolderParentPathLocator'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'????? ??? ?? ??? ???' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TblOrderPrint', @level2type=N'COLUMN',@level2name=N'OrderType'
GO
...
/* [PhotographyAutomationDB].[dbo].[TblPrintItalianAlbums] */
